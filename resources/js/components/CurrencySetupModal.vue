...
const page = usePage<{ needsCurrencySetup: boolean; currencies: Record<string, string> }>();
        ...
        <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
            <div class="w-full max-w-md rounded-2xl border border-sidebar-border bg-card p-6 shadow-2xl">
                <div class="mb-2 flex items-center gap-3">
                    ...
                    <h2 class="text-base font-semibold">Choose your currency</h2>
                </div>
                <p class="text-muted-foreground mb-5 text-sm">
                    All your balances and reports will use this currency. You can change it anytime in Preferences.
                </p>
