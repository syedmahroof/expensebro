...
async function deleteEntity(id: number) {
    const ok = await confirm(
        'All tagged transactions will have their entity tag removed.',
        {
            title: 'Delete entity?',
            confirmText: 'Delete',
            danger: true,
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-5 p-4 md:p-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-muted-foreground">
                    Tag expenses by vehicle, office, team, house and more
                </p>
            </div>
            <button
                @click="openCreate"
        ...
        <div
            ...
            class="flex flex-1 items-center justify-center rounded-xl border border-dashed border-sidebar-border/50 p-16 text-center"
        >
            <div>
                <div
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Create entities to group your expenses — vehicles, offices,
                    houses, and more.
                </p>
                <button
                    @click="openCreate"
        ...
        <div v-else class="flex flex-col gap-2">
            ...
            >
                ...
                >
                    <span v-if="entity.emoji" class="text-lg leading-none">{{
                        entity.emoji
                    }}</span>
                    <component
                        v-else
                ...
                <div class="min-w-0 flex-1">
                    <div class="flex items-center gap-2">
                        ...
                        <span
                            class="shrink-0 rounded-full px-1.5 py-0.5 text-[10px] font-semibold tracking-wide uppercase"
                            :style="{
                ...
                <div class="shrink-0 text-right">
                    ...
                    <p class="text-xs text-muted-foreground">
                        {{ entity.transactions_count ?? 0 }} txns
                    </p>
                </div>
